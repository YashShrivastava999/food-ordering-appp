class USER():
    ...
    def place_order(self):
        list_of_foods = [{"name":"Tandoori Chicken","quantity":"4 pieces","price":"INR 260"},
                        {"name":"Veg Burger","quantity":"1 Piece" ,"price":"INR 310"},
                        {"name":"ice cream","quantity":"500gm" ,"price":"INR 90"}]
        self.ordered_item = []
